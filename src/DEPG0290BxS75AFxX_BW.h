...
class DEPG0290BxS75AFxX_BW: public EpdBase {
    public:
        DEPG0290BxS75AFxX_BW(uint8_t _rst, uint8_t _dc, uint8_t _cs,  uint8_t _busy, int8_t _clk=-1, uint8_t _spi_num = 0 ,uint32_t _freq = 2000000): \
        EpdBase(_rst, _dc, _cs, _busy, _clk, _spi_num, _freq){}

        ~DEPG0290BxS75AFxX_BW(){};
